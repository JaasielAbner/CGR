...
turn_h = 1
turn_v = 0
sphere_quality = 100 # max = 100

def keyboard(key,x,y):
    global spin, turn_h, turn_v, angle_h, angle_v, sphere_quality
...
def display():
    ...
    glutSolidSphere(0.45, sphere_quality, sphere_quality*2)
    
    # Bola meio
    glTranslatef(0.0, 0.45, 0.0)
    glutSolidSphere(0.3, sphere_quality, sphere_quality*2)
    
    #Bola cabeca
    glTranslatef(0.0, 0.35, 0.0)
    glutSolidSphere(0.25, sphere_quality, sphere_quality*2)
    ...
    glutSolidSphere(1.3, sphere_quality, sphere_quality)
    glPopMatrix()
    #Externo
    glPushMatrix()
    ...
    glTranslatef(0.0, -0.5, 0.0)
    glRotatef(90.0, 1, 0, 0)
    glutSolidSphere(1.4, sphere_quality, sphere_quality)
    glPopMatrix()
